...
const { register, login, validateEmailToken, resetConfirmEmailToken, forgotPassword, resetPassword, sentAccountValidationEmail, logout } = require('../controllers/Auth/AuthController');
