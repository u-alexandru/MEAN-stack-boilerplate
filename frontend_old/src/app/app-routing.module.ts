...
import { BaseComponent as UserBaseComponent } from './views/user-layout/base/base.component';
...
const routes: Routes = [
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      {
        path: '',
        loadChildren: () => import('./views/users/dashboard/dashboard.module').then(m => m.DashboardModule)
      },
      {
        path: '',
